...
public class Constant {
     ...
     * 更新指示JSON文件下载地址
     */
    public static final String UPDATE_JSON_URL = "https://wishes-blog.cn/shimeji/DeskTopPetVersion.json";

    /**
     * 默认主程序包下载地址
     */
    public static final String DEFAULT_JAR_DOWNLOAD_URL = "https://wishes-blog.cn/shimeji/shimeji.jar";
