...
public class Script extends Variable {
	...
	public Script(final String source, final boolean clearAtInitFrame)  throws VariableException {
		...
		try {
			...
			throw new VariableException( Main.getInstance( ).getLanguageBundle( ).getProperty( "ScriptCompilationErrorMessage" ) + ": "+this.source, e);
		}
	}
	...
	public synchronized Object get(final VariableMap variables)  throws VariableException {
		...
		try {
			...
			throw new VariableException( Main.getInstance( ).getLanguageBundle( ).getProperty( "ScriptEvaluationErrorMessage" ) + ": "+this.source, e);
		}
