...
public class Area {
    ...
    public boolean equals(Object obj) {
        Area area = (Area) obj;
        if (this.left != area.getLeft() && this.right != area.getRight()
                && this.top != area.getTop() && this.bottom != area.getBottom()) {
            return false;
        } else {
            return true;
        }
     ...
     * @return
     */
    public synchronized boolean isScreen() {
        if (getLeft() == 0 && getRight() == 0 && getTop() == 0 && getBottom() == 0) {
            return true;
        } else {
            return false;
        }
