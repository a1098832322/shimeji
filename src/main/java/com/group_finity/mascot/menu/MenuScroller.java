...
public class MenuScroller {
  ...
  public MenuScroller(JPopupMenu menu, int scrollCount, int interval,
    ...
    if (scrollCount <= 0 || interval <= 0) {
      throw new IllegalArgumentException( Main.getInstance( ).getLanguageBundle( ).getProperty( "ScrollCountIntervalBelowZeroErrorMessage" ) );
    }
    if (topFixedCount < 0 || bottomFixedCount < 0) {
      throw new IllegalArgumentException( Main.getInstance( ).getLanguageBundle( ).getProperty( "CountsCannotBeNegativeErrorMessage" ) );
    }
  ...
  public void setInterval(int interval) {
    if (interval <= 0) {
      throw new IllegalArgumentException( Main.getInstance( ).getLanguageBundle( ).getProperty( "IntervalBelowZeroErrorMessage" ) );
    }
  ...
  public void setScrollCount(int scrollCount) {
    if (scrollCount <= 0) {
      throw new IllegalArgumentException( Main.getInstance( ).getLanguageBundle( ).getProperty( "ScrollCountErrorMessage" ) );
    }
